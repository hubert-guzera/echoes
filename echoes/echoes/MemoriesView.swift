                        ...
                        ScrollView {
                            LazyVStack(spacing: 12) {
                                ForEach(realtimeManager.recordingRecords) { recording in
                                    NavigationLink(destination: RecordingDetailsView(recording: recording).environmentObject(realtimeManager)) {
                                        CloudRecordingCardNavigationView(recording: recording)
                                    }
